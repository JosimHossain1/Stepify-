    ...
    <div className='bg-white rounded-md px-4 py-6 h-max shadow-sm border border-gray-200'>
      <ul className='text-slate-500 font-medium space-y-4'>
        <li className='flex flex-wrap gap-4 text-sm'>
          Subtotal{' '}
          <span className='ml-auto font-semibold text-slate-900'>$200.00</span>
        </li>
        <li className='flex flex-wrap gap-4 text-sm'>
          Shipping{' '}
          <span className='ml-auto font-semibold text-slate-900'>$2.00</span>
        </li>
        <li className='flex flex-wrap gap-4 text-sm'>
          Tax{' '}
      ...
      <div className='mt-8 space-y-4'>
       {
        user ?  <Link href='/checkout' className='w-full'>
          <Button variant='default' className='w-full cursor-pointer mb-3'>
            Proceed to Checkout
          </Button>
        </Link> : <Link href='/login' className='w-full'>
          <Button variant='default' className='w-full cursor-pointer mb-3'>
            Login to Checkout
          </Button>
        </Link>
